...
def initialize_db():
    with sqlite3.connect('gestor_emprendimientos.db') as conn:
        c = conn.cursor()
        c.execute('''
...
def eliminar_cliente_seleccionado():
    ...
    respuesta = messagebox.askyesno("Confirmación", "¿Estás seguro de que deseas eliminar el Emprendimiento?")
...
def agregar_cliente():
    ...
    ventana_formulario.title("Agregar Emprendimiento")
...
def editar_cliente_form():
    ...
    ventana_formulario = tk.Toplevel(window)
    ventana_formulario.title("Editar Emprendimiento")
...
def mostrar_prendas_fecha():
    ...
    def obtener_datos_desde_db():
        ...
        conn = sqlite3.connect('gestor_emprendimientos.db')
        cursor = conn.cursor()
...
#Logo y Nombre
tk.Label(frame_clients, text="Zorritas Emprendimientos").grid(row=0, column=1, sticky=tk.NSEW)
ruta_logo = 'fox_scarf_icon_emprendi.png'
...
label_cliente_nombre = tk.Label(frame_clients, text="Nombre del Emprendimiento", width=150, textvariable=nomb_variable)
label_cliente_nombre.grid(row=6, column=1, sticky=tk.W)
tel_variable = tk.StringVar()
label_cliente_telefono = tk.Label(frame_clients, text="Telefono del Emprendimiento", width=150, textvariable=tel_variable)
label_cliente_telefono.grid(row=7, column=1, sticky=tk.NS)
ig_variable = tk.StringVar()
label_cliente_ig = tk.Label(frame_clients, text="ig del Emprendimiento", width=150, textvariable=ig_variable)
...
btn_add_client = tk.Button(frame_clients, text="Agregar Emprendimiento", command=agregar_cliente, width=27)
btn_modif_cliente = tk.Button(frame_clients, text="Modificar Emprendimiento", command=editar_cliente_form, width=27)
btn_eliminar_cliente = tk.Button(frame_clients, text="Eliminar Emprendimiento", command=eliminar_cliente_seleccionado, width=27)
