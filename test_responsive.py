...
#Logo y Nombre
tk.Label(frame_clients, text="Zorritas VIntage").grid(row=0, column=1, sticky=tk.E, padx=10, pady=10)
ruta_logo = 'fox_scarf_icon_159308.png'
imagen = PhotoImage(file=ruta_logo)
label_logo = tk.Label(frame_clients, image=imagen)
label_logo.grid(row=1, column=1, padx=10, pady=10, sticky=tk.E)
...
garments_tree.column("Description", stretch=tk.YES, width=60, anchor=CENTER)  # 60% of the screen width
garments_tree.column("Price Real", stretch=tk.YES, minwidth=10, width=10, anchor=CENTER)
garments_tree.column("Price 40", stretch=tk.YES, minwidth=10, width=10, anchor=CENTER)
garments_tree.column("Price 50", stretch=tk.YES, minwidth=10, width=10, anchor=CENTER)
garments_tree.column("Cobrada", stretch=tk.YES, minwidth=10, width=10, anchor=CENTER)
garments_tree.column("Fecha", stretch=tk.YES, minwidth=10, width=10, anchor=CENTER)
garments_tree.column("Fecha_cob", stretch=tk.YES, minwidth=10, width=10, anchor=CENTER)
...
# #Opciones de prendas
btn_add_garment = tk.Button(frame_clients, text="Agregar Prenda")
btn_delete_garment = tk.Button(frame_clients, text="Eliminar Prenda")
btn_ver_prendas = tk.Button(frame_clients, text="Ver Prendas",)
btn_mark_as_paid = tk.Button(frame_clients, text="Cobrada", )
btn_mark_as_no_paid = tk.Button(frame_clients, text="No Cobrada")
